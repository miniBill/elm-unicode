...
import Elm.CodeGen as Elm exposing (Declaration(..), and, apply, applyBinOp, boolAnn, charAnn, construct, emptyDocComment, emptyFileComment, equals, fqVal, fun, funAnn, funDecl, funExpose, gte, hex, ifExpr, int, letExpr, letVal, lt, lte, normalModule, or, parens, varPattern)
import Elm.Pretty
import Hex
import Result
...
init csv =
    let
        ...
        fileComment =
            emptyFileComment
                |> Elm.markdown "This is the autogenerated code"
