    ...
    if code < 0x0100 then
        ...
        if code < 0x000115D7 then
            ...
            (code >= 0x000115D8 && code <= 0x000115DB)
                ...
                || (code >= 0x000118FF && code <= 0x0001192F)
                || (modBy 2 code == 1 && (code >= 0x0001193F && code <= 0x00011941))

        else if code < 0x00011A5B then
            (code >= 0x00011950 && code <= 0x00011959)
                || (code >= 0x000119A0 && code <= 0x000119D0)
                || (code == 0x00011A00)
                || (code >= 0x00011A0B && code <= 0x00011A32)
                || (code == 0x00011A3A)
                || (code == 0x00011A50)
                || (modBy 2 code == 1 && (code >= 0x000119E1 && code <= 0x000119E3))
