...
isUpper c =
    ...
    in
    if code < 0x0100 then
        simple && (code >= 0x41 && code <= 0xFF)

    else if code < 0xA7D5 then
        if code < 0x1FC7 then
            if code < 0x10C6 then
                (simple && (code >= 0x0100 && code <= 0x0377))
                    || (simple && (code == 0x037F))
                    || (simple && (code >= 0x0386 && code <= 0x038A))
                    || (simple && (code == 0x038C))
                    || (simple && (code >= 0x038E && code <= 0x03A1))
                    || (simple && (code >= 0x03A3 && code <= 0x03D1))
                    || (code >= 0x03D2 && code <= 0x03D4)
                    || (simple && (code >= 0x03D8 && code <= 0x052F))
                    || (simple && (code >= 0x0531 && code <= 0x0556))
                    || (simple && (code >= 0x10A0 && code <= 0x10C5))

            else
                (simple && (code == 0x10C7))
                    || (simple && (code == 0x10CD))
                    || (simple && (code >= 0x13A0 && code <= 0x13F5))
                    || (simple && (code >= 0x1C90 && code <= 0x1CBA))
                    || (simple && (code >= 0x1CBD && code <= 0x1CC7))
                    || (simple && (code >= 0x1E00 && code <= 0x1F15))
                    || (simple && (code >= 0x1F18 && code <= 0x1F1D))
                    || (simple && (code >= 0x1F28 && code <= 0x1F45))
                    || (simple && (code >= 0x1F48 && code <= 0x1F4D))
                    || (simple && (code >= 0x1F5F && code <= 0x1F7D))
                    || (simple && (code >= 0x1FB8 && code <= 0x1FC4))
                    || ((modBy 2 code == 1)
                            && (simple && (code >= 0x1F59 && code <= 0x1F5D))
                       )

        else if code < 0x2125 then
            (simple && (code >= 0x1FC8 && code <= 0x1FD3))
                || (simple && (code >= 0x1FD8 && code <= 0x1FDB))
                || (simple && (code >= 0x1FE8 && code <= 0x1FEF))
                || (simple && (code >= 0x1FF8 && code <= 0x1FFE))
                || (code == 0x2102)
                || (code == 0x2107)
            ...
            (simple && (code >= 0x2126 && code <= 0x2127))
                || (code == 0x2128)
                || (code >= 0x212A && code <= 0x212D)
                || (code >= 0x2130 && code <= 0x2133)
                || (code >= 0x213E && code <= 0x213F)
                || (code == 0x2145)
                || (simple && (code >= 0x2183 && code <= 0x218B))
                || (simple && (code >= 0x2C00 && code <= 0x2CF3))
                || (simple && (code >= 0xA640 && code <= 0xA6F7))
                || (simple && (code >= 0xA722 && code <= 0xA7CA))
                || (simple && (code >= 0xA7D0 && code <= 0xA7D1))

    else if code < 0x0001D503 then
        if code < 0x00016E3F then
            (simple && (code >= 0xA7D6 && code <= 0xA7D9))
                || (simple && (code >= 0xA7F5 && code <= 0xA82C))
                || (simple && (code >= 0xFF21 && code <= 0xFFBE))
                || (simple && (code >= 0x00010400 && code <= 0x0001049D))
                || (simple && (code >= 0x000104B0 && code <= 0x000104D3))
                || (simple && (code >= 0x00010570 && code <= 0x0001057A))
                || (simple && (code >= 0x0001057C && code <= 0x0001058A))
                || (simple && (code >= 0x0001058C && code <= 0x00010592))
                || (simple && (code >= 0x00010594 && code <= 0x00010595))
                || (simple && (code >= 0x00010C80 && code <= 0x00010CB2))
                || (simple && (code >= 0x000118A0 && code <= 0x000118F2))

        else
            (simple && (code >= 0x00016E40 && code <= 0x00016E9A))
        ...
        (code >= 0x0001D5D4 && code <= 0x0001D5ED)
            ...
            || (code == 0x0001D7CA)
            || (simple && (code >= 0x0001E900 && code <= 0x0001E94B))
...
isLower c =
    ...
    in
    if code < 0x0100 then
        simple && (code >= 0x61 && code <= 0xFF)

    else if code < 0x2D26 then
        if code < 0x1E00 then
            if code < 0x023B then
                if code < 0x01A9 then
                    (simple && (code >= 0x0100 && code <= 0x0137))
                        || (code == 0x0138)
                        || (simple && (code >= 0x013A && code <= 0x018C))
                        || (code == 0x018D)
                        || (simple && (code >= 0x0192 && code <= 0x019A))
                        || (code == 0x019B)
                        || (simple && (code >= 0x019E && code <= 0x01A8))

                else
                    (simple && (code == 0x01A9))
                        || (code >= 0x01AA && code <= 0x01AB)
                        || (simple && (code >= 0x01AD && code <= 0x01B9))
                        || (code == 0x01BA)
                        || (code >= 0x01BD && code <= 0x01BF)
                        || (simple && (code >= 0x01C6 && code <= 0x0220))
                        || (code == 0x0221)
                        || (simple && (code >= 0x0223 && code <= 0x0233))
                        || (code >= 0x0234 && code <= 0x0239)

            else if code < 0x042F then
                (simple && (code >= 0x023C && code <= 0x0254))
                    || (code >= 0x0255 && code <= 0x0293)
                    || (code >= 0x0295 && code <= 0x02AF)
                    || (simple && (code >= 0x0371 && code <= 0x0377))
                    || (simple && (code >= 0x037B && code <= 0x037F))
                    || (simple && (code >= 0x0390 && code <= 0x03A1))
                    || (simple && (code >= 0x03AC && code <= 0x03FB))
                    || (code == 0x03FC)

            else
                (simple && (code >= 0x0430 && code <= 0x052F))
                    || (code >= 0x0560 && code <= 0x0588)
                    || (simple && (code >= 0x10D0 && code <= 0x1248))
                    || (simple && (code >= 0x13F8 && code <= 0x13FD))
                    || (simple && (code >= 0x1C80 && code <= 0x1C88))
            ...
            if code < 0x1FB5 then
                (simple && (code >= 0x1E01 && code <= 0x1E9B))
                    || (code >= 0x1E9C && code <= 0x1E9D)
                    || (code == 0x1E9F)
                    || (simple && (code >= 0x1EA1 && code <= 0x1F15))
                    || (simple && (code >= 0x1F20 && code <= 0x1F45))
                    || (simple && (code >= 0x1F50 && code <= 0x1F57))
                    || (simple && (code >= 0x1F60 && code <= 0x1F7D))
                    || (simple && (code >= 0x1F80 && code <= 0x1FB4))

            else
                (simple && (code >= 0x1FB6 && code <= 0x1FC4))
                    || (simple && (code >= 0x1FC6 && code <= 0x1FD3))
                    || (simple && (code >= 0x1FD6 && code <= 0x1FDB))
                    || (simple && (code >= 0x1FE0 && code <= 0x1FEF))
                    || (simple && (code >= 0x1FF2 && code <= 0x1FF4))
                    || (simple && (code >= 0x1FF6 && code <= 0x1FFE))
                    || (code == 0x210A)
            ...
            (code == 0x2113)
                ...
                || (simple && (code >= 0x214E && code <= 0x216F))
                || (simple && (code >= 0x2184 && code <= 0x218B))

        else
            (simple && (code >= 0x2C30 && code <= 0x2C70))
                || (code == 0x2C71)
                || (code >= 0x2C73 && code <= 0x2C74)
                || (code >= 0x2C76 && code <= 0x2C7B)
                || (simple && (code >= 0x2C81 && code <= 0x2CE3))
                || (code == 0x2CE4)
                || (simple && (code >= 0x2CEC && code <= 0x2CF3))
                || (simple && (code >= 0x2D00 && code <= 0x2D25))

    else if code < 0x00016E5F then
        if code < 0xA7F5 then
            if code < 0xA78D then
                (simple && (code == 0x2D27))
                    || (simple && (code == 0x2D2D))
                    || (simple && (code >= 0xA641 && code <= 0xA6F7))
                    || (simple && (code >= 0xA723 && code <= 0xA72F))
                    || (code >= 0xA730 && code <= 0xA731)
                    || (simple && (code >= 0xA733 && code <= 0xA770))
                    || (code >= 0xA771 && code <= 0xA778)
                    || (simple && (code >= 0xA77A && code <= 0xA78C))

            else
                (simple && (code == 0xA78D))
                    || (code == 0xA78E)
                    || (simple && (code >= 0xA791 && code <= 0xA794))
                    || (code == 0xA795)
                    || (simple && (code >= 0xA797 && code <= 0xA7AE))
                    || (code == 0xA7AF)
                    || (simple && (code >= 0xA7B5 && code <= 0xA7CA))
                    || (simple && (code == 0xA7D1))
                    || (simple && (code >= 0xA7D7 && code <= 0xA7D9))
                    || ((modBy 2 code == 1)
                            && (code >= 0xA7D3 && code <= 0xA7D5)
                       )

        else if code < 0x00010427 then
            (simple && (code >= 0xA7F6 && code <= 0xA7F9))
                || (code == 0xA7FA)
                || (code >= 0xAB30 && code <= 0xAB5A)
                || (code >= 0xAB60 && code <= 0xAB68)
                || (simple && (code >= 0xAB70 && code <= 0xABED))
                || (simple && (code >= 0xFB00 && code <= 0xFB06))
                || (simple && (code >= 0xFB13 && code <= 0xFB17))
                || (simple && (code >= 0xFF41 && code <= 0xFFBE))

        else
            (simple && (code >= 0x00010428 && code <= 0x0001049D))
                || (simple && (code >= 0x000104D8 && code <= 0x000104FB))
                || (simple && (code >= 0x00010597 && code <= 0x000105A1))
                || (simple && (code >= 0x000105A3 && code <= 0x000105B1))
                || (simple && (code >= 0x000105B3 && code <= 0x000105B9))
                || (simple && (code >= 0x000105BB && code <= 0x000105BC))
                || (simple && (code >= 0x00010CC0 && code <= 0x00010CF2))
                || (simple && (code >= 0x000118C0 && code <= 0x000118F2))

    else if code < 0x0001D655 then
        if code < 0x0001D4C4 then
            (simple && (code >= 0x00016E60 && code <= 0x00016E9A))
        ...
        (code >= 0x0001D770 && code <= 0x0001D788)
            ...
            || (simple && (code >= 0x0001E922 && code <= 0x0001E94B))
...
isAlpha c =
    ...
    in
    if code < 0x0100 then
        (simple && (code >= 0x41 && code <= 0xA9))
            || (code == 0xAA)
            || (simple && (code >= 0xB5 && code <= 0xB9))
            || (code == 0xBA)
            || (simple && (code >= 0xC0 && code <= 0xFF))
                    ...
                    if code < 0x061F then
                        if code < 0x038B then
                            ...
                            (simple && (code == 0x038C))
                                ...
                                || (simple && (code >= 0x048A && code <= 0x052F))
                                || (simple && (code >= 0x0531 && code <= 0x0556))
                                || (code == 0x0559)
                                || (code >= 0x0560 && code <= 0x0588)
                ...
                if code < 0x12C7 then
                    if code < 0x124F then
                        (code >= 0x106E && code <= 0x1070)
                            ...
                            || (simple && (code == 0x10C7))
                            || (simple && (code == 0x10CD))
                            || (simple && (code >= 0x10D0 && code <= 0x10FB))
            ...
            if code < 0x2182 then
                if code < 0x2114 then
                    ...
                    (code == 0x2115)
                        ...
                        || (simple && (code >= 0x214E && code <= 0x215F))

            else if code < 0x2DA7 then
                (simple && (code >= 0x2183 && code <= 0x218B))
                    || (code >= 0x2C00 && code <= 0x2CE4)
                    || (simple && (code >= 0x2CEB && code <= 0x2CF3))
                    || (simple && (code >= 0x2D00 && code <= 0x2D25))
                    || (simple && (code == 0x2D27))
                    || (simple && (code == 0x2D2D))
            ...
            if code < 0xFB45 then
                ...
                if code < 0xFFC1 then
                    (code >= 0xFB46 && code <= 0xFBB1)
                        ...
                        || (simple && (code >= 0xFF21 && code <= 0xFF65))
        ...
        else if code < 0x00010E7F then
            if code < 0x000108FF then
        ...
        if code < 0x00011D97 then
            if code < 0x0001199F then
                if code < 0x000116B7 then
        ...
        if code < 0x0001EE33 then
            (code >= 0x0001E800 && code <= 0x0001E8C4)
                || (simple && (code >= 0x0001E900 && code <= 0x0001E94A))
                || (code == 0x0001E94B)
...
isAlphaNum c =
    ...
    if code < 0x0100 then
        ...
        if code < 0x00010807 then
            ...
            if code < 0x00010AC8 then
                if code < 0x0001091F then
                    (code == 0x00010808)
                        || (code >= 0x0001080A && code <= 0x00010835)
                        || (code >= 0x00010837 && code <= 0x00010838)
                        || (code == 0x0001083C)
        ...
        else if code < 0x0001128E then
            if code < 0x00011175 then
        ...
        if code < 0x00011FFF then
            if code < 0x00011A4F then
                if code < 0x000118FE then
                    (code >= 0x00011600 && code <= 0x0001162F)
                        || (code == 0x00011644)
        ...
        if code < 0x0001D735 then
            ...
            (code == 0x0001E14E)
                ...
                || (simple && (code >= 0x0001E900 && code <= 0x0001E949))

    else if code < 0x0001EE73 then
        if code < 0x0001EE23 then
            (simple && (code == 0x0001E94A))
                || (code == 0x0001E94B)
